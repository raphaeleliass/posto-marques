...
export function ContactSection() {
	return (
		...
		>
			<div
				data-scroll-reveal
				className="rounded-[2.2rem] border border-pm-neon/20 bg-[radial-gradient(circle_at_10%_20%,var(--color-pm-neon-soft),transparent_28%),linear-gradient(135deg,rgba(255,255,255,0.07),rgba(255,255,255,0.03))] p-8 shadow-2xl shadow-pm-neon/5 sm:p-10 lg:p-14"
			>
				<div className="grid gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
					...
					<div className="grid gap-4">
						<a
							href="https://wa.me/5528999380253"
						...
						<a
							...
							className="flex items-center justify-between rounded-3xl border border-white/10 bg-white/5 p-5 text-pm-text transition hover:border-pm-orange/50 hover:bg-pm-orange/10"
						>
